...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.nombreU && campos.nombreR && campos.usuarioR && campos.password && campos.correo && campos.cedulaR){
		var usuario1 = new Usuario(cedulaR.value.toString(), nombreR.value.toString(), nombreU.value.toString(), correo.value.toString(), usuarioR.value.toString(), password.value.toString(),"activo");
