...
function cargarDatos(){
	...
	for(var i=0; i<usuarios.length ; i++){
		...
		newFiladeTabla.insertCell(7).innerHTML = '<input style="background-color:#001245 ; color:white; border-color:white" type="submit" id="editar" value="Editar" onclick="abrirPopUp('+(i) +')"> <br> <input style="background-color:#570F10; color:white; border-color:white" color="danger" type="submit" id="eliminar" value="Eliminar" onclick="eliminar('+(i) +')">';
	}
}