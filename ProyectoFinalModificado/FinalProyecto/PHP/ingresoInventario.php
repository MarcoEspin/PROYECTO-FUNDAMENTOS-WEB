                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div class="col-atuo">
                                    <a class="btn btn-danger btn-sm btn-flat" href="inventario_nuevo.php" style="background-color: #134459;border-color: #134459"><i
                                            ...
                                            onclick="DescargaArchivo('../DATOS/inventario.json','Inventario.json')" 
                                    ...
                                    <tbody>
                                        <?php foreach ($json_data as $data): ?>
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a style="background-color: #134459;color: #FFF0F0;" href="inventario_nuevo.php?id=<?= $data->id ?>"
                                                        class="btn btn-sm btn-outline-info rounded-0">
                                                        <i class="fa-solid fa-edit">U</i>
                                                    </a>
                                                    <a style="background-color: #640000;color: #FFF0F0;" href="inventario_elimina.php?id=<?= $data->id ?>"
