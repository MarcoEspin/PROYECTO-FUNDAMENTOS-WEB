...
<link rel="stylesheet" href="CSS/estilo.css">
    ...
    <script src="../JS/validacionInventario.js" ></script>
                            ...
                            <div class="container-fluid">
                                ...
                                <form id="member-form" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="cantidadIn" name="cantidadIn" required="required" onblur="validarEnteroPositivo(this)" value="<?= isset($data->cantidadIn) ? $data->cantidadIn: '' ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="precioIn" class="form-label">Precio en dólares</label>
                                        <input type="text" class="form-control rounded-0" id="precioIn" name="precioIn" required="required" onblur="validarPrecio(this)"  value="<?= isset($data->precioIn) ? $data->precioIn: '' ?>">
                                    </div>
                                    <div class="mb-3">
