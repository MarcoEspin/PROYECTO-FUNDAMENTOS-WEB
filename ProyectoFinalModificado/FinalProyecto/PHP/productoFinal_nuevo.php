...
<body>
    ...
    <div class="container px-5 my-3">
        <h2 class="text-center">Orden de Pruducto Final</h2>
        <div class="row">
                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                <div class="card-title col-auto flex-shrink-1 flex-grow-1">Datos de la Cabecera del Producto Final </div>
                              <!--  <div class="col-atuo">
                        ...
                        <div class="card-body">
                            <div class="container-fluid">
                                ...
                                <?php else : ?>
                                    <p class="text-muted"><i>Añadir Nombre del Producto</b></i></p>
                                <?php endif; ?>
                                <form id="member-form" action="" method="POST">
                                    <input type="hidden" name="id" value="<?= isset($data->id) ? $data->id : '' ?>">
                                    <div class="mb-3">
											<div class="mb-3">
												<label for="nProductoFinal" class="form-label">Nombre del Producto Final</label>
												<input type="text" class="form-control rounded-0" id="nProductoFinal" name="nProductoFinal" required="required" value="<?= isset($data->nProductoFinal) ? $data->nProductoFinal: '' ?>">
											</div>
                                    </div>
                                     <!--<div class="mb-3">
                                        <label for="cantidadPfinal" class="form-label">Catidad</label>
                                        <input type="text" class="form-control rounded-0" id="cantidadPfinal" name="cantidadPfinal" step="1" required="required" value="<?= isset($data->cantidadPfinal) ? $data->cantidadPfinal: '' ?>">
                                    </div>
                                -->
                                </form>
                            </div>
