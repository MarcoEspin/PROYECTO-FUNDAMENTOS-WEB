                                ...
                                <form id="member-form" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="nproducto">
                                            <option value="<?= isset($data->nProductoFinal) ? $data->nProductoFinal: '0' ?>"><?= isset($data->nProductoFinal) ? $data->nProductoFinal: '                                           ' ?></option>
                                            <?php foreach ($listadoProductos as $datos): 
                                                    echo '<option value="'.$datos->nProductoFinal.'">'.$datos->nProductoFinal.'</option>';
                                                 endforeach; 
                                            ?>
                                        </select>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="ncantidad" name="ncantidad" required="required" value="<?= isset($data->cantidadPfinal) ? $data->cantidadPfinal: '' ?>">
                                    </div>
