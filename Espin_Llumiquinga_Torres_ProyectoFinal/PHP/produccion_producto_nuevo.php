...
$data = $master->get_data(isset($_GET['norden']) ? $_GET['norden'] : '');
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="container-fluid">
                                ...
                                <form id="member-form" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="nprecio" name="nprecio" required="required" value="<?= isset($data->nprecio) ? $data->nprecio: '' ?>">
                                    </div>
