                            ...
                            <div class="container-fluid">
                                ...
                                <form id="member-form" action="" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control rounded-0" id="telefonoc" name="telefonoc" required="required" onblur="validarTelefono(this)" value="<?= isset($data->telefonoc) ? $data->telefonoc: '' ?>">
                                    </div>
                                    <div class="mb-3">
                                        <label for="correoc" class="form-label">Correo electrónico</label>
                                        <input type="text" class="form-control rounded-0" id="correoc" name="correoc" required="required" onblur="validarCorreo(this)" value="<?= isset($data->correoc) ? $data->correoc: '' ?>">
                                    </div>
                                    <div class="mb-3">
