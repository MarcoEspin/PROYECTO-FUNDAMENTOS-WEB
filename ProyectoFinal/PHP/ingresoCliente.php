                    ...
                    <div class="card rounded-0 shadow">
                        <div class="card-header">
                            <div class="d-flex justify-content-between">
                                ...
                                <nav class="botonesx">
                                <div class="col-atuo">
                                    <a class="btn btn-danger btn-sm btn-flat" href="clientes_nuevo.php"><i
                                            class="fa fa-plus-square"></i>&nbsp Agregar Cliente</a>
                                            <button class="btn btn-primary btn-sm btn-flat" onclick="imprimir()"><i
                                ...
                                <table class="table table-stripped table-bordered">
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center">Celular del Cliente</th>
